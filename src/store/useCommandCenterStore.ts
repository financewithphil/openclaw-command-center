...
const mockAgents: AgentNode[] = [
  // Kit's org — Phil's Master Claw system
  {
    id: 'kit-main',
    clientId: 'kit-001',
    name: 'Kit',
    emoji: '🦊',
    role: 'Master Claw / COO',
    goal: 'Orchestrate all department heads, coordinate cross-functional work, ensure alignment with Phil\'s strategic priorities',
    reportsTo: null,
    communicatesWith: ['kit-grant', 'kit-community', 'kit-finance', 'kit-program', 'kit-outreach', 'kit-webdev-mgr'],
    taskTypes: ['Strategic planning', 'Agent dispatch', 'Quality control', 'Context management', 'Memory maintenance', 'Heartbeat monitoring'],
  ...
  },
  {
    ...
    name: 'Grant Manager',
    emoji: '🎯',
    role: 'Grant Research, Writing & Compliance',
    goal: 'Secure funding through grant applications — target $300K+ annual budget for Finance With Phil Inc',
    reportsTo: 'kit-main',
    communicatesWith: ['kit-main', 'kit-finance', 'kit-program'],
  ...
  },
  {
    ...
    emoji: '🏆',
    role: 'Skool Community Growth & Engagement',
    goal: 'Grow "From Ideas to Income" Skool community — engagement tracking, member retention, content strategy',
    reportsTo: 'kit-main',
    communicatesWith: ['kit-main', 'kit-outreach'],
  ...
  },
  {
    ...
    emoji: '💰',
    role: 'Financial Planning & Sustainability',
    goal: 'Build financial sustainability — diversify revenue, maintain 3-month reserves, achieve $300K+ annual budget',
    reportsTo: 'kit-main',
    communicatesWith: ['kit-main', 'kit-grant', 'kit-program'],
  ...
  },
  {
    ...
    emoji: '📚',
    role: 'Program Delivery & Impact Measurement',
    goal: 'Scale from 750 to 1,200+ individuals served annually with 85%+ completion rate',
    reportsTo: 'kit-main',
    communicatesWith: ['kit-main', 'kit-finance', 'kit-grant'],
  ...
  },
  {
    ...
    emoji: '🤝',
    role: 'Marketing, Partnerships & Stakeholder Relations',
    goal: 'Build community partnerships, manage brand presence, grow referral network across metro Atlanta',
    reportsTo: 'kit-main',
    communicatesWith: ['kit-main', 'kit-community', 'kit-webdev-mgr'],
  ...
  },
  {
    ...
    name: 'Webdev Manager',
    emoji: '🛠️',
    role: 'Multi-Business Web Development Lead',
    goal: 'Build and maintain websites for 4 businesses — Peachtree Parking, Finance With Phil, Intellovate AI, Personal Brand',
    reportsTo: 'kit-main',
    communicatesWith: ['kit-main', 'kit-outreach', 'kit-webdev-arch', 'kit-webdev-build', 'kit-webdev-content', 'kit-webdev-qa'],
  ...
  },
  {
    id: 'kit-webdev-arch',
    clientId: 'kit-001',
    name: 'Webdev Architect',
    emoji: '📐',
    role: 'Site Planning & Technical Architecture',
    goal: 'Audit existing sites, plan technical architecture, document requirements for all 4 business websites',
    reportsTo: 'kit-webdev-mgr',
    communicatesWith: ['kit-webdev-mgr', 'kit-webdev-build'],
  ...
  },
  {
    ...
    name: 'Webdev Builder',
    emoji: '🔨',
    role: 'WordPress Development & Staging',
    goal: 'Set up staging environments, install plugins (Elementor Pro, Yoast, WPForms), build pages',
    reportsTo: 'kit-webdev-mgr',
    communicatesWith: ['kit-webdev-mgr', 'kit-webdev-arch', 'kit-webdev-qa'],
  ...
  },
  {
    ...
    clientId: 'kit-001',
    name: 'Webdev Content Agent',
    emoji: '📂',
    role: 'Brand Assets & Google Drive Management',
    goal: 'Organize brand assets across all 4 businesses, maintain Google Drive structure with weekly archives',
    reportsTo: 'kit-webdev-mgr',
    communicatesWith: ['kit-webdev-mgr', 'kit-outreach'],
  ...
  },
  {
    id: 'kit-webdev-qa',
    clientId: 'kit-001',
    name: 'Webdev QA Agent',
    emoji: '✅',
    role: 'Quality Assurance & Launch Readiness',
    goal: 'Ensure all sites pass mobile responsiveness, page speed, SSL, SEO, forms, and analytics checks before launch',
    reportsTo: 'kit-webdev-mgr',
    communicatesWith: ['kit-webdev-mgr', 'kit-webdev-build'],
  ...
  // Jacob's org — simple single agent
  {
    ...
    goal: 'Help Jacob with daily tasks — emails, meetings, reminders, document summaries, and proactive support',
    reportsTo: null,
    communicatesWith: [],
    taskTypes: ['Email sending', 'Meeting notes', 'Document summaries', 'iMessage communication', 'Calendar management', 'Proactive reminders'],
